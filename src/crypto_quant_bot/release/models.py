...
DEFAULT_RELEASE_BLOCK_REASONS = [
    "DEFENSIVE_RELEASE_CANDIDATE_ONLY",
    "NO_ARCHIVE_CREATED",
...
def default_release_block_reasons() -> list[str]:
    return list(DEFAULT_RELEASE_BLOCK_REASONS)


@dataclass(frozen=True)
class ReleaseCandidatePolicy:
    release_candidate_version: str = "lot19_release_candidate_v0"
    policy_version: str = "lot19_release_candidate_v0"
    ...
    packaging_state: str = "NO_ARCHIVE_CREATED"
    ...
    pytest_state: str = "EXPECTED_GREEN"
    exact_chain_state: str = "EXPECTED_GREEN"
    ...
    no_trading_compliance_valid: bool = True
    ...
    release_block_reasons: list[str] = field(default_factory=default_release_block_reasons)
...
class ReleaseCandidateSnapshot:
    ...
    release_checks: list[ReleaseCandidateCheck] = field(default_factory=list)
    release_block_reasons: list[str] = field(default_factory=default_release_block_reasons)
