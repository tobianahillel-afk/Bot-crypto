...
PATH_5M = ROOT / "data" / "audit" / "risk_engine_lot11_5m.jsonl"
PATH_15M = ROOT / "data" / "audit" / "risk_engine_lot11_15m.jsonl"
...
def test_lot11_risk_engine_outputs_exist_with_expected_counts():
    ...
    assert (ROOT / "reports" / "lot_11_risk_engine_report.md").exists()


def test_lot11_risk_engine_output_rows_are_blocked_decisions():
