...
PATH_5M = ROOT / "data" / "audit" / "decision_ledger_lot15_5m.jsonl"
PATH_15M = ROOT / "data" / "audit" / "decision_ledger_lot15_15m.jsonl"
...
def test_lot15_outputs_exist_with_expected_counts():
    ...
    assert (ROOT / "reports" / "lot_15_decision_ledger_report.md").exists()


def test_lot15_output_rows_are_blocked_ledger_records():
