...
PATH_5M = ROOT / "data" / "audit" / "portfolio_freeze_lot13_5m.jsonl"
PATH_15M = ROOT / "data" / "audit" / "portfolio_freeze_lot13_15m.jsonl"
...
def test_lot13_outputs_exist_with_expected_counts():
    ...
    assert (ROOT / "reports" / "lot_13_portfolio_freeze_report.md").exists()


def test_lot13_output_rows_are_frozen_portfolio_snapshots():
    ...
    for row in rows:
        ...
        assert row["allocation_state"] == "DISABLED"
        assert row["rebalance_state"] == "DISABLED"
