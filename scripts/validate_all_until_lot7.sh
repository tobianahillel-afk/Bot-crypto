...
check_required_artifacts() {
  ...
  require_file reports/lot_07_market_state_report.md
...
echo "=== Crypto Quant Bot validation until Lot 7 ==="
echo "mode=${MODE}"
...
if [[ "${MODE}" == "smoke" ]]; then
  ...
  echo "LOT 7 ORCHESTRATOR SMOKE: PASS"
  exit 0
fi
...
echo "LOT 7 ORCHESTRATED VALIDATION: PASS"
exit 0
