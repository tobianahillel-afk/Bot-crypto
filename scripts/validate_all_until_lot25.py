...
STEPS: list[tuple[list[str], int]] = [
    (["python", "scripts/validate_all_until_lot24.py"], 300),
    ...
    (["python", "scripts/run_lot25_volatility_regime_confluence.py"], 60),
    (["python", "scripts/validate_lot25.py"], 60),
]
...
def main() -> int:
    ...
    print("LOT 25 ORCHESTRATED VALIDATION: PASS", flush=True)
    return 0
