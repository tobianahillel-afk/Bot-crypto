...
Archive path: dist/crypto_quant_bot_v1_defensive_audit_lot_20.tar.gz

Archive SHA256 path: dist/crypto_quant_bot_v1_defensive_audit_lot_20.sha256

Archive SHA256: ef5b5998cd5f75b6d97acc4afc10aeaf4833b565d2c11e9f3278bace06c78667

Archive size bytes: 366985

Closure state: V1_DEFENSIVE_AUDIT_CLOSED

Archive state: ARCHIVE_CREATED

Release candidate state: READY_FOR_LOCAL_AUDIT_REVIEW

Acceptance state: ACCEPTANCE_BUNDLE_GENERATED

Pytest state: GREEN

Exact chain state: GREEN
...
- data/audit/replay_validation/latest_validation_replay.json
...
- data/bronze/.gitkeep
- data/bronze/BTC_EUR_1m_ohlcvt_fixture.jsonl
- data/bronze/btc_eur_ohlcvt_sample_lot1bis.jsonl
- data/gold/.gitkeep
- data/gold/btc_eur_15m_anchor_points_lot4.jsonl
...
- data/gold/btc_eur_15m_volume_profile_lot4.jsonl
- data/gold/btc_eur_15m_volume_profile_summary_lot4.jsonl
- data/gold/btc_eur_15m_vwap_lot4.jsonl
- data/gold/btc_eur_5m_anchor_points_lot4.jsonl
...
- data/gold/btc_eur_5m_volume_profile_lot4.jsonl
- data/gold/btc_eur_5m_volume_profile_summary_lot4.jsonl
- data/gold/btc_eur_5m_vwap_lot4.jsonl
- data/raw/.gitkeep
- data/raw/fixtures/BTC_EUR_1m_ohlcvt_fixture.csv
- data/silver/.gitkeep
- data/silver/btc_eur_15m_ohlcvt_lot2.jsonl
- data/silver/btc_eur_15m_ohlcvt_lot3.jsonl
- data/silver/btc_eur_15m_ohlcvt_lot4.jsonl
- data/silver/btc_eur_15m_ohlcvt_lot5.jsonl
- data/silver/btc_eur_5m_ohlcvt_lot2.jsonl
- data/silver/btc_eur_5m_ohlcvt_lot3.jsonl
- data/silver/btc_eur_5m_ohlcvt_lot4.jsonl
- data/silver/btc_eur_5m_ohlcvt_lot5.jsonl
...
- docs/FEATURE_ENGINEERING_POLICY.md
...
- docs/MARKET_STATE_ANTI_LOOKAHEAD_POLICY.md
- docs/MARKET_STATE_ENGINE_POLICY.md
- docs/MODULE_STATUS_MATRIX.md
- docs/MULTI_TIMEFRAME_POLICY.md
- docs/OPERATIONAL_THRESHOLDS.md
- docs/PIVOT_ANTI_LOOKAHEAD_POLICY.md
- docs/PIVOT_ENGINE_POLICY.md
- docs/PROJECT_IDENTITY.md
- docs/RANGE_STATE_POLICY.md
- docs/REGIME_ENGINE_POLICY.md
- docs/SECURITY_POLICY.md
- docs/SPREAD_SLIPPAGE_MODEL_POLICY.md
- docs/SUPPORT_RESISTANCE_ZONE_POLICY.md
- docs/TRANSACTION_COST_MODEL_POLICY.md
- docs/TREND_RANGE_REGIME_POLICY.md
- docs/VETO_CONSEQUENCE_MATRIX.md
- docs/VOLATILITY_ENGINE_POLICY.md
- docs/VOLUME_PROFILE_POLICY.md
- docs/VWAP_POLICY.md
- pyproject.toml
...
- src/crypto_quant_bot/audit/__init__.py
- src/crypto_quant_bot/audit/available_at.py
- src/crypto_quant_bot/audit/feature_registry_audit.py
- src/crypto_quant_bot/audit/forbidden_names.py
- src/crypto_quant_bot/audit/lookahead.py
- src/crypto_quant_bot/audit/writer.py
...
- src/crypto_quant_bot/contracts/data_quality.py
- src/crypto_quant_bot/contracts/dataset.py
- src/crypto_quant_bot/contracts/decision.py
- src/crypto_quant_bot/contracts/features.py
- src/crypto_quant_bot/contracts/market_data.py
- src/crypto_quant_bot/contracts/market_state.py
- src/crypto_quant_bot/contracts/ohlcvt.py
- src/crypto_quant_bot/contracts/pivots.py
- src/crypto_quant_bot/contracts/range_state.py
- src/crypto_quant_bot/contracts/regime.py
- src/crypto_quant_bot/contracts/replay.py
- src/crypto_quant_bot/contracts/risk.py
- src/crypto_quant_bot/contracts/security.py
- src/crypto_quant_bot/contracts/timeframe.py
- src/crypto_quant_bot/contracts/volatility.py
- src/crypto_quant_bot/contracts/volume_profile.py
- src/crypto_quant_bot/contracts/vwap.py
- src/crypto_quant_bot/contracts/zones.py
- src/crypto_quant_bot/core/__init__.py
...
- src/crypto_quant_bot/data/__init__.py
- src/crypto_quant_bot/data/catalog.py
- src/crypto_quant_bot/data/checksum.py
- src/crypto_quant_bot/data/data_writer.py
- src/crypto_quant_bot/data/materialize.py
- src/crypto_quant_bot/data/metadata.py
- src/crypto_quant_bot/data/ohlcvt_parser.py
- src/crypto_quant_bot/data/quality.py
...
- src/crypto_quant_bot/features/__init__.py
- src/crypto_quant_bot/features/basic.py
- src/crypto_quant_bot/features/registry.py
- src/crypto_quant_bot/features/writer.py
...
- src/crypto_quant_bot/market_state/__init__.py
- src/crypto_quant_bot/market_state/assembler.py
- src/crypto_quant_bot/market_state/loader.py
- src/crypto_quant_bot/market_state/nearest.py
- src/crypto_quant_bot/market_state/quality.py
- src/crypto_quant_bot/market_state/writer.py
- src/crypto_quant_bot/pivots/__init__.py
- src/crypto_quant_bot/pivots/fractal.py
- src/crypto_quant_bot/pivots/strength.py
- src/crypto_quant_bot/pivots/writer.py
...
- src/crypto_quant_bot/regime/__init__.py
- src/crypto_quant_bot/regime/classifier.py
- src/crypto_quant_bot/regime/confidence.py
- src/crypto_quant_bot/regime/trend.py
- src/crypto_quant_bot/regime/writer.py
...
- src/crypto_quant_bot/replay/__init__.py
...
- src/crypto_quant_bot/security/__init__.py
- src/crypto_quant_bot/security/security_policy.py
- src/crypto_quant_bot/timeframes/__init__.py
- src/crypto_quant_bot/timeframes/resampler.py
- src/crypto_quant_bot/timeframes/timeframe.py
- src/crypto_quant_bot/volatility/__init__.py
- src/crypto_quant_bot/volatility/atr.py
- src/crypto_quant_bot/volatility/engine.py
- src/crypto_quant_bot/volatility/range_state.py
- src/crypto_quant_bot/volatility/realized.py
- src/crypto_quant_bot/volatility/writer.py
- src/crypto_quant_bot/volume/__init__.py
- src/crypto_quant_bot/volume/anchors.py
- src/crypto_quant_bot/volume/profile.py
- src/crypto_quant_bot/volume/vwap.py
- src/crypto_quant_bot/volume/writer.py
- tests/__init__.py
- tests/conftest.py
- tests/fixtures/BTC_EUR_1m_ohlcvt_fixture.csv
- tests/fixtures/btc_eur_ohlcvt_1m_180_pivots.csv
- tests/fixtures/btc_eur_ohlcvt_1m_60.csv
...
- tests/test_dataset_catalog_atomic_write_shared_fs.py
...
- tests/test_no_ci_termination_hacks.py
- tests/test_no_stdout_stderr_detach_hacks.py
- tests/test_no_test_runner_shadowing.py
- tests/test_pytest_suite_has_no_active_extended_subprocesses.py
- tests/test_pytest_termination_clean.py
